# Scenario: affiliate_cookie_stuffing

## 1. Purpose
Validate affiliate URL fetch and silent tab open/close behavior in a controlled environment using mock endpoints only.

## 2. Matched Static Pattern
Server-provided affiliate URL (containing awinaffid/awinmid parameters) opened via chrome.tabs.create indicates affiliate cookie stuffing behavior.

## 3. Expected Flows
target_domain_visit -> affiliate_url_fetch_from_server -> tabs_create -> affiliate_cookie_set -> tab_close.
