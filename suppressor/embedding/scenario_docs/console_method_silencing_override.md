# Scenario: console_method_silencing_override

## 1. Purpose
Validate anti-analysis behavior that silences console methods and confirm effect through harness console hooks only.

## 2. Matched Static Pattern
window.console reassignment and multi-method override patterns indicate debugging visibility suppression.

## 3. Expected Flows
script load -> console method override -> reduced console outputs observed by collector hooks.
